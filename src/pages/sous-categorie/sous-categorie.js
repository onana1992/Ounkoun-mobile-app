...
var SousCategoriePage = /** @class */ (function () {
    function SousCategoriePage(navCtrl, popoverCtrl, navParams, restProvider, modalCtrl, alertCtrl, storage, actionSheetCtrl, toastController) {
        var _this = this;
        ...
        this.restProvider.getProduitPerSousCat(this.sousCategorieName, this.page, this.filterOption, this.filterMinPrice, this.filterMaxPrice, this.filterMarque).subscribe(function (data) {
    ...
    SousCategoriePage.prototype.ionViewDidLoad = function () {
        console.log('ionViewDidLoad CategoriePage');
    };
    SousCategoriePage.prototype.scrollToTop = function () {
        // Scrolls to the top, ie 0px to top.
        this.content.scrollToTop();
    };
    SousCategoriePage.prototype.cancelFilter = function () {
        var _this = this;
        this.filterMinPrice = "null";
        this.filterMaxPrice = "null";
        this.filterMarque = "null";
    ...
    SousCategoriePage.prototype.showFiltreModal = function () {
        var _this = this;
        var myModal = this.modalCtrl.create(FitreModalSouscatPage, { categorie: this.categorieName, sousCat: this.sousCategorieName });
        myModal.present();
        myModal.onDidDismiss(function (data) {
            if (data != undefined) {
                if (data.filter == "marque") {
                    ...
                    _this.restProvider.getProduitPerSousCat(_this.sousCategorieName, _this.page, _this.filterOption, _this.filterMinPrice, _this.filterMaxPrice, _this.filterMarque).subscribe(function (data) {
                        _this.response = data.data;
                        _this.produits = data.data.products;
                        _this.nbProduits = data.data.size;
                        _this.isLoading = false;
    ...
    SousCategoriePage.prototype.changeView = function (view) {
        if (view === "view1") {
            this.view = "view2";
        }
        else if (view === 'view2') {
    ...
    SousCategoriePage.prototype.showTriChoix = function () {
        var _this = this;
        ...
        alert.addButton({
            ...
            handler: function (data) {
                ...
                _this.isLoading = true;
                _this.restProvider.getProduitPerSousCat(_this.sousCategorieName, _this.page, data, _this.filterMinPrice, _this.filterMaxPrice, _this.filterMarque).subscribe(function (data) {
                    _this.response = data.data;
                    _this.produits = data.data.products;
                    _this.isLoading = false;
                    console.log(data);
    ...
    SousCategoriePage.prototype.showPageChoix = function () {
        var _this = this;
        var modulo = 0;
        var nbPage = 0;
        var alert = this.alertCtrl.create();
    ...
    SousCategoriePage.prototype.goSuivant = function () {
        var _this = this;
        var modulo = 0;
        var nbPage = 0;
        modulo = this.nbProduits % 40;
    ...
    SousCategoriePage.prototype.goPrecedant = function () {
        var _this = this;
        if (this.page > 1) {
            this.isLoading = true;
            this.page--;
    ...
    SousCategoriePage.prototype.gotoProduct = function (productName) {
        this.navCtrl.push(ProduitPage, { ProduitName: productName });
    };
    SousCategoriePage.prototype.objecttoParams = function (obj) {
        var p = [];
        for (var key in obj) {
    ...
    SousCategoriePage.prototype.addFavorite = function (produit, event) {
        var _this = this;
    ...
    SousCategoriePage.prototype.addPanier = function (produit, event) {
        var _this = this;
        event.stopPropagation(); //THIS DOES THE MAGIC
        var number = 0;
    ...
    SousCategoriePage.prototype.openPanier = function () {
        this.navCtrl.push(PanierPage);
    };
    SousCategoriePage.prototype.goTorecheche = function () {
        this.navCtrl.push(RecherchePage);
    };
    SousCategoriePage.prototype.openFavoris = function () {
        if (this.isConnected) {
    ...
    SousCategoriePage.prototype.disconnect = function () {
        var _this = this;
        var alert = this.alertCtrl.create();
    ...
    SousCategoriePage.prototype.presentPopover = function (event) {
        var _this = this;
    ...
    SousCategoriePage.prototype.addPanier1 = function (produit) {
        var _this = this;
        var number = 0;
        this.storage.get('panier').then(function (val) {
            if (val != null) {
    ...
    SousCategoriePage.prototype.presentActionSheet = function (produitName, modelName) {
        var _this = this;
        this.isLoading = true;
    ...
    ], SousCategoriePage.prototype, "content", void 0);
    SousCategoriePage = __decorate([
        IonicPage(),
        Component({
    ...
    return SousCategoriePage;
}());
export { SousCategoriePage };
//# sourceMappingURL=sous-categorie.js.map