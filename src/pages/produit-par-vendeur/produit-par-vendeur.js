...
var ProduitParVendeurPage = /** @class */ (function () {
    function ProduitParVendeurPage(navCtrl, popoverCtrl, navParams, restProvider, modalCtrl, alertCtrl, storage, actionSheetCtrl, toastController) {
        var _this = this;
        ...
        this.sellerName = navParams.get('seller');
        ...
        this.restProvider.getProduitPerSeller(this.sellerName, this.page, this.filterOption).subscribe(function (data) {
    ...
    ProduitParVendeurPage.prototype.ionViewDidLoad = function () {
        console.log('ionViewDidLoad CategoriePage');
    };
    ProduitParVendeurPage.prototype.scrollToTop = function () {
        // Scrolls to the top, ie 0px to top.
        this.content.scrollToTop();
    };
    ProduitParVendeurPage.prototype.changeView = function (view) {
        if (view === "view1") {
            this.view = "view2";
        }
        else if (view === 'view2') {
    ...
    ProduitParVendeurPage.prototype.showTriChoix = function () {
        var _this = this;
        ...
        alert.addButton({
            ...
            handler: function (data) {
                ...
                _this.restProvider.getProduitPerSeller(_this.sellerName, _this.page, data).subscribe(function (data) {
                    _this.response = data.data;
                    _this.produits = data.data.products;
                    _this.isLoading = false;
                    console.log(data);
    ...
    ProduitParVendeurPage.prototype.showPageChoix = function () {
        var _this = this;
        var modulo = 0;
        var nbPage = 0;
        var alert = this.alertCtrl.create();
        ...
        alert.addButton({
            ...
            handler: function (data) {
                ...
                console.log('Radio data:', data);
                _this.isLoading = true;
                _this.restProvider.getProduitPerSeller(_this.sellerName, _this.page, _this.filterOption).subscribe(function (data) {
                    _this.response = data.data;
                    _this.produits = data.data.products;
                    _this.isLoading = false;
                    console.log(data);
    ...
    ProduitParVendeurPage.prototype.goSuivant = function () {
        var _this = this;
        var modulo = 0;
        var nbPage = 0;
        modulo = this.nbProduits % 40;
    ...
    ProduitParVendeurPage.prototype.goPrecedant = function () {
        var _this = this;
        if (this.page > 1) {
            this.isLoading = true;
            this.page--;
    ...
    ProduitParVendeurPage.prototype.gotoProduct = function (productName) {
        this.navCtrl.push(ProduitPage, { ProduitName: productName });
    };
    ProduitParVendeurPage.prototype.objecttoParams = function (obj) {
        var p = [];
        for (var key in obj) {
    ...
    ProduitParVendeurPage.prototype.addFavorite = function (produit, event) {
        var _this = this;
    ...
    ProduitParVendeurPage.prototype.addPanier = function (produit, event) {
        var _this = this;
        event.stopPropagation(); //THIS DOES THE MAGIC
        var number = 0;
    ...
    ProduitParVendeurPage.prototype.openPanier = function () {
        this.navCtrl.push(PanierPage);
    };
    ProduitParVendeurPage.prototype.openFavoris = function () {
        if (this.isConnected) {
    ...
    ProduitParVendeurPage.prototype.disconnect = function () {
        var _this = this;
        var alert = this.alertCtrl.create();
    ...
    ProduitParVendeurPage.prototype.presentPopover = function (event) {
        var _this = this;
    ...
    ProduitParVendeurPage.prototype.addPanier1 = function (produit) {
        var _this = this;
        var number = 0;
        this.storage.get('panier').then(function (val) {
            if (val != null) {
    ...
    ProduitParVendeurPage.prototype.presentActionSheet = function (produitName, modelName) {
        var _this = this;
        this.isLoading = true;
    ...
    ], ProduitParVendeurPage.prototype, "content", void 0);
    ProduitParVendeurPage = __decorate([
        IonicPage(),
        Component({
            selector: 'page-produit-par-vendeur',
            templateUrl: 'produit-par-vendeur.html',
        }),
    ...
    return ProduitParVendeurPage;
}());
export { ProduitParVendeurPage };
//# sourceMappingURL=produit-par-vendeur.js.map